...
<input type="hidden" name="email_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['email_']); ?>">
<input type="hidden" name="cpf_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['cpf_']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doadores_1__1_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_doadores_1__1_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_doadores_1__1_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_doadores_1']['where_detal']))
  {
?>  
  if (parent && parent.nmsc_iframe_liga_form_doadores_1.scInlineFormReceive)
  {
    parent.nmsc_iframe_liga_form_doadores_1.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doadores_1__1_mob']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
...
?>  
  ...
  {
    parent.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_doadores_1__1_mob']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
